...
DOCS = {
    ...
    "role-patient": {
        "src": OUT / "roles" / "patient",
        "basename": "DrPoojaPhysio-Role-Patient",
        "title": "Dr. Pooja's Physio - Patient Test Plan",
        "subtitle": "Everything a patient can do, from never having heard of the clinic to a delivered programme",
        "meta": [
            ("Role", "Patient"),
            ("Document version", "1.0"),
            ("Audience", "A tester checking this role end to end"),
            ("Environment", "Throwaway Supabase project · Razorpay test mode · npm run dev"),
            ("Read first", "Section 1 - who this is, and what has to exist before you start"),
        ],
    },
    "role-therapist": {
        "src": OUT / "roles" / "therapist",
        "basename": "DrPoojaPhysio-Role-Therapist",
        "title": "Dr. Pooja's Physio - Therapist Test Plan",
        "subtitle": "Everything a clinician can do, from applying to being paid",
        "meta": [
            ("Role", "Therapist"),
            ("Document version", "1.0"),
            ("Audience", "A tester checking this role end to end"),
    ...
    "role-hospital": {
        "src": OUT / "roles" / "hospital",
        "basename": "DrPoojaPhysio-Role-Hospital",
        "title": "Dr. Pooja's Physio - Partner Hospital Test Plan",
        "subtitle": "Everything a referring partner can do, from enquiry to commission",
        "meta": [
    ...
    "role-master": {
        "src": OUT / "roles" / "master",
        "basename": "DrPoojaPhysio-Role-MasterAdmin",
        "title": "Dr. Pooja's Physio - Master Admin Test Plan",
        "subtitle": "Every screen and every control in the back office",
        "meta": [
            ("Role", "Master Admin"),
            ("Document version", "1.0"),
            ("Audience", "A tester checking this role end to end"),
    ...
    "role-operations": {
        "src": OUT / "roles" / "operations",
        "basename": "DrPoojaPhysio-Role-Operations",
        "title": "Dr. Pooja's Physio - Operations Admin Test Plan",
        "subtitle": "The operations desk: what it opens, what it changes, and what it is refused",
        "meta": [
    ...
    "role-finance": {
        "src": OUT / "roles" / "finance",
        "basename": "DrPoojaPhysio-Role-Finance",
        "title": "Dr. Pooja's Physio - Finance Admin Test Plan",
        "subtitle": "The finance desk: the books, and the sessions it may read but never change",
        "meta": [
            ("Role", "Finance Admin"),
            ("Document version", "1.0"),
            ("Audience", "A tester checking this role end to end"),
    ...
    "role-clinical": {
        "src": OUT / "roles" / "clinical",
        "basename": "DrPoojaPhysio-Role-Clinical",
        "title": "Dr. Pooja's Physio - Clinical Admin Test Plan",
        "subtitle": "The clinical desk: patients, sessions and care records, and nothing financial",
        "meta": [
            ("Role", "Clinical Admin"),
            ("Document version", "1.0"),
            ("Audience", "A tester checking this role end to end"),
    ...
    "role-visitor": {
        "src": OUT / "roles" / "visitor",
        "basename": "DrPoojaPhysio-Role-Visitor",
        "title": "Dr. Pooja's Physio - Signed-Out Visitor Test Plan",
        "subtitle": "What a stranger sees, what they may buy, and what must never be reachable",
        "meta": [
            ("Role", "Signed-Out Visitor"),
            ("Document version", "1.0"),
            ("Audience", "A tester checking this role end to end"),
            ("Environment", "Throwaway Supabase project · Razorpay test mode · npm run dev"),
            ("Read first", "Section 1 - who this is, and what has to exist before you start"),
