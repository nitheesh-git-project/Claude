  ...
  const csv = useMemo(
    () =>
      toCsv(filtered, [
        ...
        { header: "Category", value: (p) => p.categoryTitle },
        ...
        { header: "Total Sessions", value: (p) => p.sessionCount },
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-end gap-3">
        ...
        <FilterSelect label="Category" value={categoryId} onChange={setCategoryId} options={categories.map((c) => ({ value: c.id, label: c.title }))} />
        <FilterSelect
          label="Status"
          value={status}
          onChange={setStatus}
