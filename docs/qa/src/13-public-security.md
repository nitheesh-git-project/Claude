...
**Expected Result.** A teal band with the copy on the left — headline, one line, one or two buttons — and a **photograph on the right**. The band's shape is identical on all seven, but **each page shows a different photograph**, and never one that page already shows further up: home a patient booking on her phone, Conditions Treated a patient exercising to her laptop, How It Works a patient reaching for her laptop, Home Visit a therapist treating a patient at home, Our Team a patient with her physiotherapist on screen, Mission an older couple at their tablet, FAQ a physiotherapist at his desk. Over the photo, a white chip reading **Session confirmed / Tuesday, 6:00 PM / Calendar invite on its way.** and, underneath it, **Example of what you get** — the chip must always say it is an example, on every page.
